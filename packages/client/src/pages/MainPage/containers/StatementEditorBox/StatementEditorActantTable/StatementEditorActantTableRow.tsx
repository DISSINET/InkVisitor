          ...
          options={[
            {
              ...
              onClick: () =>
                updateActant(sActant.id, {
                  position: actantPositionDict[EntityEnums.Position.Subject].value,
                }),
              selected:
                sActant.position == actantPositionDict[EntityEnums.Position.Subject].value,
            },
            {
              ...
              onClick: () =>
                updateActant(sActant.id, {
                  position: actantPositionDict[EntityEnums.Position.Actant1].value,
                }),
              selected:
                sActant.position == actantPositionDict[EntityEnums.Position.Actant1].value,
            },
            {
              ...
              onClick: () =>
                updateActant(sActant.id, {
                  position: actantPositionDict[EntityEnums.Position.Actant2].value,
                }),
              selected:
                sActant.position == actantPositionDict[EntityEnums.Position.Actant2].value,
            },
            {
              longValue: actantPositionDict[EntityEnums.Position.PseudoActant].label,
              shortValue: actantPositionDict[EntityEnums.Position.PseudoActant].value,
              onClick: () =>
                updateActant(sActant.id, {
                  position: actantPositionDict[EntityEnums.Position.PseudoActant].value,
                }),
              selected:
                sActant.position ==
