...
describe("statements/batch-move", function () {
  describe("Empty/Invalid params", () => {
    it("should return a BadParams error wrapped in IResponseGeneric for empty params", (done) => {
      return request(app)
    ...
    it("should return a BadParams error wrapped in IResponseGeneric for missing territory id", (done) => {
      return request(app)
    ...
    it("should return a BadParams error wrapped in IResponseGeneric for missing ids", (done) => {
      return request(app)
        .put(`${apiPath}/statements/batch-move`)
        .send({ territoryId: '1' })
        .set("authorization", "Bearer " + supertestConfig.token)
